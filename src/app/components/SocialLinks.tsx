...
const SocialLinks: React.FC = () => {
  ...
  return (
    <div
      ref={socialLinksRef}
      className="hidden md:block fixed bottom-0 left-12 z-10"
    >
        ...
        {socialLinks.map((link, index) => (
          <li key={index} className="social-link">
            <a
              ...
              className="block w-6 h-6 text-muted-foreground hover:text-brand hover:-translate-y-1 transition-all duration-300"
            >
              {link.icon}
            </a>
          </li>
