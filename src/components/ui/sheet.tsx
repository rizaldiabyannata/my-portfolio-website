...
>(({ className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-out data-[state=closed]:animate-out data-[state=open]:animate-in right-0 top-0 h-full w-[85vw] max-w-sm flex flex-col border-l border-border",
        className
      )}
      {...props}
    >
